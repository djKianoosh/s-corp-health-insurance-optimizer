    ...
    <div className="mb-4">
      ...
      <div className="relative rounded-md shadow-sm">
        ...
        <input
          ...
          className={`block w-full rounded-md border-slate-300 bg-white py-2 ${prefix ? 'pl-7' : 'pl-3'} ${suffix ? 'pr-12' : 'pr-3'} text-slate-900 ring-1 ring-inset ring-slate-300 placeholder:text-slate-400 focus:ring-2 focus:ring-inset focus:ring-blue-600 sm:text-sm sm:leading-6`}
          placeholder="0"
        />
        {suffix && (
